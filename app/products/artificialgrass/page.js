    ...
    const unsub = onSnapshot(collection(db, 'ArtificialGrass'), (snap) => {
      const list = snap.docs.map((d) => {
        ...
        return {
          ...
          id: d.id, // Also keep as id for compatibility
  ...
  const handleAddOrSave = async () => {
    ...
    try {
      ...
      if (editingProd) {
        ...
        const ref = doc(db, 'ArtificialGrass', docId)
          ...
          <div className="px-4 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 lg:flex-none lg:text-center">
                <h1 className="text-2xl font-bold text-gray-900">Artificial Grass</h1>
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              />
                ...
                {newProduct.features.map((f, i) => (
                    ...
                    <input
                      type="text"
                              placeholder="e.g., The high pile density delivers lasting comfort"
                      value={f.description || ''}
