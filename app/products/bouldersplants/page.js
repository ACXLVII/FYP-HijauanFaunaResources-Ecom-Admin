...
const currentRoute = '/products/bouldersplants'
...
export default function ProductsPage() {
  ...
  const [activeNav, setActiveNav] = useState('Boulders Rocks')
          ...
          <div className="px-4 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 lg:flex-none lg:text-center">
                <h1 className="text-2xl font-bold text-gray-900">Boulders Rocks</h1>
